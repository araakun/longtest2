...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (firstName.toUpperCase().equals("ARABELLAGRACIE") || surName.toLowerCase().equals("gonzaga")) {
            System.out.println("Valid");
        } else {
            System.out.println("Invalid");
        }
        ...
        String studentEmailAdd = "gonzagaap@students.national-u.edu.ph";

        switch (studentEmailAddress) {
            case "gonzagaap@students.national-u.edu.ph":
            System.out.println("Valid ");
            break;
            default:
            System.out.println("Invalid ");
